    ...
    __stages: immutabledict.immutabledict[
    ...
    ] = immutabledict.immutabledict(
        {
            "phase_1_1": (
                ...
                "Phase 1 1",
                datetime.datetime.strptime("7 November 1987", "%d %B %Y").replace(
            ...
            "phase_1_2": (
                ...
                "Phase 1 2",
                datetime.datetime.strptime("12 December 1987", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "phase_1a": (
                ...
                "Phase 1A",
                datetime.datetime.strptime("12 March 1988", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "phase_2b_1": (
                ...
                "Phase 2B 1",
                datetime.datetime.strptime("5 November 1988", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "phase_2b_2": (
                ...
                "Phase 2B 2",
                datetime.datetime.strptime("20 December 1988", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "phase_2a_1": (
                ...
                "Phase 2A 1",
                datetime.datetime.strptime("4 November 1989", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "phase_2a_2": (
                ...
                "Phase 2A 2",
                datetime.datetime.strptime("16 December 1989", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "phase_2b_3": (
                ...
                "Phase 2B 3",
                datetime.datetime.strptime("10 March 1990", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "phase_2b_4": (
                ...
                "",
                datetime.datetime.strptime("6 July 1990", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "woodlands_extension": (
                ...
                "Phase 2B 4",
                datetime.datetime.strptime("10 February 1996", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "bplrt": (
                ...
                "Bukit Panjang LRT",
                datetime.datetime.strptime("6 November 1999", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "ewl_expo": (
                ...
                "East West Line Expo",
                datetime.datetime.strptime("10 January 2001", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "dover": (
                ...
                "Dover",
                datetime.datetime.strptime("18 October 2001", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "ewl_changi_airport": (
                ...
                datetime.datetime.strptime("8 February 2002", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "sklrt_east_loop": (
                ...
                datetime.datetime.strptime("18 January 2003", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "nel": (
                ...
                "North East Line",
                datetime.datetime.strptime("20 June 2003", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "pglrt_east_loop_and_sklrt_west_loop": (
                ...
                datetime.datetime.strptime("29 January 2005", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "buangkok": (
                ...
                "Buangkok",
                datetime.datetime.strptime("15 January 2006", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "oasis": (
                ...
                "Oasis",
                datetime.datetime.strptime("15 June 2007", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "farmway": (
                ...
                "Farmway",
                datetime.datetime.strptime("15 November 2007", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "ewl_boon_lay_extension": (
                ...
                datetime.datetime.strptime("28 February 2009", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "ccl_3": (
                ...
                "Circle Line Stage 3",
                datetime.datetime.strptime("28 May 2009", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "ccl_1_and_ccl_2": (
                ...
                datetime.datetime.strptime("17 April 2010", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "ten_mile_junction_temporary_closure": (
                ...
                datetime.datetime.strptime("10 December 2010", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "woodleigh_and_damai": (
                ...
                "Woodleigh and Damai",
                datetime.datetime.strptime("20 June 2011", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "ccl_4_and_ccl_5": (
                ...
                datetime.datetime.strptime("8 October 2011", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "ten_mile_junction_reopen": (
                ...
                datetime.datetime.strptime("30 December 2011", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "ccl_e": (
                ...
                datetime.datetime.strptime("14 January 2012", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "cheng_lim": (
                ...
                "Cheng Lim",
                datetime.datetime.strptime("1 January 2013", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "dtl_1": (
                ...
                "Downtown Line 1",
                datetime.datetime.strptime("22 December 2013", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "pglrt_west_loop": (
                ...
                datetime.datetime.strptime("29 June 2014", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "marina_south_pier": (
                ...
                "Marina South Pier",
                datetime.datetime.strptime("23 November 2014", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "kupang": (
                ...
                "Kupang",
                datetime.datetime.strptime("27 June 2015", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "dtl_2": (
                ...
                "Downtown Line 2",
                datetime.datetime.strptime("27 December 2015", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "sam_kee": (
                ...
                "Sam Kee",
                datetime.datetime.strptime("29 February 2016", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "punggol_point": (
                ...
                "Punggol Point",
                datetime.datetime.strptime("29 December 2016", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "samudera": (
                ...
                "Samudera",
                datetime.datetime.strptime("31 March 2017", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "ewl_tuas_extension": (
                ...
                datetime.datetime.strptime("18 June 2017", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "dtl_3": (
                ...
                "Downtown Line 3",
                datetime.datetime.strptime("21 October 2017", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "ten_mile_junction_permanent_closure": (
                ...
                datetime.datetime.strptime("13 January 2019", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "canberra": (
                ...
                "Canberra",
                datetime.datetime.strptime("2 November 2019", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "tel_1": (
                ...
                datetime.datetime.strptime("31 January 2020", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "tel_2": (
                ...
                datetime.datetime.strptime("28 August 2021", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "tel_3": (
                ...
                datetime.datetime.strptime("13 November 2022", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "tel_4": (
                ...
                datetime.datetime.strptime("23 June 2024", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "teck_lee": (
                ...
                "Teck Lee",
                datetime.datetime.strptime("15 August 2024", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "nel_extension": (
                ...
                datetime.datetime.strptime("10 December 2024", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "hume": (
                ...
                "Hume",
                datetime.datetime.strptime("28 February 2025", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "ccl_6": (
                ...
                "Circle Line 6",
                datetime.datetime.strptime("12 July 2026", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),
            ),
            "tel_5_and_dtl_3e": (
                ...
                datetime.datetime.strptime("30 November 2026", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),  # TBC
            ),
            "jrl_1": (
                ...
                datetime.datetime.strptime("31 July 2028", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),  # TBC
            ),
            "founders_memorial": (
                ...
                "Founders' Memorial",
                datetime.datetime.strptime("30 November 2028", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),  # TBC
            ),
            "jrl_2": (
                ...
                datetime.datetime.strptime("31 July 2029", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),  # TBC
            ),
            "jrl_3": (
                ...
                datetime.datetime.strptime("31 July 2030", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),  # TBC
            ),
            "crl_1": (
                ...
                "Cross Island Line 1",
                datetime.datetime.strptime("31 December 2030", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),  # TBC
            ),
            "crl_2": (
                ...
                "Cross Island Line 2",
                datetime.datetime.strptime("30 November 2032", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),  # TBC
            ),
            "crl_pe": (
                ...
                datetime.datetime.strptime("31 December 2032", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),  # TBC
            ),
            "brickland": (
                ...
                "Brickland",
                datetime.datetime.strptime("31 December 2034", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),  # TBC
            ),
            "jrl_js2a": (
                ...
                "Forest Hill",
                datetime.datetime.strptime("31 December 2035", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),  # TBC
            ),
            "dtl_2e": (
            ...
            "tel_e": (
                ...
                datetime.datetime.strptime("31 December 2040", "%d %B %Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),  # TBC
            ),
            "future": (
                ...
                "Future",
                datetime.datetime.strptime("9999", "%Y").replace(
                    tzinfo=datetime.timezone(datetime.timedelta(hours=8))
                ),  # TBC
